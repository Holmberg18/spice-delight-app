        ...
        <nav className="border-gray-200 border-b border-gray-100">
            ...
            <div onClick={() => setMobileVisible(!mobileVisible)} className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:hidden">
                ...
                <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                        <li>
                            <Link to="/">
                                <div className="block py-2 pl-3 pr-4 text-gray-900 bg-blue-700 rounded dark:bg-blue-600 dark:hover:text-white" aria-current="page">Home</div>
                            </Link>
                        </li>
                        <li>
                            <Link to="/products">
                        ...
                        <li>
                            <Link to="/cart" className="dark:hover:text-white">
                                <Cart />
                            </Link>
                        </li>
                </ul>
