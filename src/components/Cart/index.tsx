...
const Cart = () => {
    ...
    return(
        <div ref={dropdownMenu} className="relative py-2 pl-3 pr-4 text-black-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0">
            <button onClick ={() => setDropdownVisible(!dropdownVisible)} className="text-gray-700 bg-blue-700 hover:bg-blue-800 md:hover:text-blue focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
            ...
            <div id="dropdown" className={`absolute z-10 ${dropdownVisible ? "" : "hidden"} py-2 bg-black divide-y divide-gray-100 rounded-lg shadow w-72`}>
